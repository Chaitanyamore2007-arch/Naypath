...
# Define the exact block to remove. Since it was appended by the script, we can match it.
block_to_remove = r"""                      <div className="mt-6">
...
content = re.sub(block_to_remove, "", content, count=1)
